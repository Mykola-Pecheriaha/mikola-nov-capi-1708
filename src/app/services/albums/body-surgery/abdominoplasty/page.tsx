...
export default function AbdominoplastyAlbumPage(): ReactElement {
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-12">
      <div className="container-custom">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto">
          Результати операцій з підтяжки живота. Процедура дозволяє видалити надлишки шкіри та жиру,
          підтягнути м`язи та створити красивий контур талії.
        </p>
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-900">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Абдомінопластика — операція для підтяжки живота, яка включає видалення надлишків шкіри,
            корекцію м`язів та ліпосакцію для досягнення плоского та красивого живота.
          </p>
