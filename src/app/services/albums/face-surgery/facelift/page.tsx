...
export default function FaceliftAlbumPage(): ReactElement {
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-12">
      <div className="container-custom">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto">
          Результати операцій з підтяжки обличчя (фейсліфтинг). Процедура дозволяє омолодити
          обличчя, покращити контури та відновити природну красу.
        </p>
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-900">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Фейсліфтинг — комплексна операція для омолодження обличчя, яка включає підтяжку шкіри,
            корекцію м&apos;язів та видалення надлишків тканин.
          </p>
