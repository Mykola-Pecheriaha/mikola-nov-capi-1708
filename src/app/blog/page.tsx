...
const blogPosts: BlogPost[] = [
  {
    ...
    content: 'Правильна підготовка до пластичної операції є ключем до успішного результату. Необхідно проконсультуватися з лікарем, пройти обстеження...',
  ...
  },
  {
    ...
    content: 'Період реабілітації є критично важливим для досягнення оптимальних результатів. Перший тиждень вимагає особливої обережності...',
    author: 'Др. Миколай Печеріга',
    date: '15 грудня 2025',
  ...
  },
  {
    ...
    content: 'Сучасна пластична хірургія обличчя розвивається з дивовижною швидкістю. Нові технології дозволяють досягати більш натуральних результатів...',
    author: 'Др. Миколай Печеріга',
    date: '12 грудня 2025',
    category: 'Тренди',
  ...
  },
  {
    ...
    content: 'Лімфодренаж є невід\'ємною частиною реабілітаційного процесу. Правильна техніка дозволяє значно прискорити процес загоєння...',
    author: 'Др. Миколай Печеріга',
    date: '10 грудня 2025',
    category: 'Реабілітація',
    image: '/images/gallery-images/gallery-images1.jpg',
  ...
  },
  {
    ...
    content: 'Не всім пацієнтам потрібна хірургічна операція. Часто достатньо неінвазивних процедур для досягнення бажаних результатів...',
    author: 'Др. Миколай Печеріга',
    date: '8 грудня 2025',
    category: 'Методи',
    image: '/images/gallery-images/gallery-images10.jpg',
  ...
  },
  {
    ...
    content: 'Психологічна підготовка настільки ж важлива, як і фізична. Пацієнти, які психологічно готові до змін, часто мають більш позитивні результати...',
    author: 'Др. Миколай Печеріга',
    date: '5 грудня 2025',
    category: 'Психологія',
    image: '/images/gallery-images/gallery-images12.jpg',
...
export default function BlogPage() {
  ...
  const filteredPosts = selectedCategory === 'Всі'
    ? blogPosts
