...
interface GeneraCholeStartGalleryProps {
  images: GalleryImage[];
}

export function GeneraCholeStartGallery({ images }: GeneraCholeStartGalleryProps) {
...
export default GeneraCholeStartGallery;
