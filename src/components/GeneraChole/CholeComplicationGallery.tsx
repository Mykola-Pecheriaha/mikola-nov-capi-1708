...
interface CholeComplicationGalleryProps {
  images: GalleryImage[];
}

export function CholeComplicationGallery({ images }: CholeComplicationGalleryProps) {
...
export default CholeComplicationGallery;
