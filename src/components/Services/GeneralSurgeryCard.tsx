...
const mainList = [
  ...
  { label: "пластика білої лінії живота", link: "/services/general-white-line" },
];
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg flex flex-col md:flex-row overflow-hidden my-8 relative z-10">
      ...
      <div className="md:w-1/3 w-full min-w-[120px] bg-gray-100 flex items-center justify-center p-2 md:p-4 min-h-[180px] h-[180px] md:h-[220px] max-w-[320px] max-h-[240px] md:max-w-[300px] md:max-h-[220px] mx-auto">
        <Image src="/images/gallery-images/gallery-images7.jpg" alt="Загальна хірургія" width={300} height={220} className="rounded-lg object-cover object-top w-full h-full max-w-full max-h-full" style={{objectFit:'cover', objectPosition:'top', width:'100%', height:'100%', position:'static'}} />
      </div>
      {/* Права частина текст */}
      <div className="md:w-2/3 w-full p-6 flex flex-col">
        <h2 className="text-2xl font-bold mb-2">Загальна хірургія</h2>
        <ul className="mb-2">
