  ...
  return (
    ...
    >
      <div className="container-custom">
        <h2 className="text-3xl md:text-4xl text-center mb-8 text-gray-800 dark:text-gray-100 relative pb-4 font-bold">
          Поширені запитання
        ...
        <div className="h-0.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent my-8 rounded"></div>

        <div className="flex flex-col gap-5">
          {faqItems.map((item, index) => (
            <div
              key={index}
              className="rounded-xl overflow-hidden shadow-lg bg-white dark:bg-gray-800 border border-blue-100 dark:border-blue-900"
            >
              <div
              ...
              {openItem === index && (
                <div className="flex flex-col lg:flex-row p-5 bg-blue-50/30 dark:bg-gray-700/30 animate-fadeIn border-t border-blue-100 dark:border-blue-900 gap-8">
                  <div className="flex-1 pr-0 lg:pr-5 text-base leading-relaxed text-gray-700 dark:text-gray-300">
                    {item.answer.split('\n').map((paragraph, i) => (
