...
export function ConsultationGallery({ images }: ConsultationGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-96 sm:h-[400px] md:h-[600px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-500 dark:text-gray-400 text-lg sm:text-xl">
  ...
  return (
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-64 sm:h-80 md:h-[400px] lg:h-[600px] bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg">
        {/* Навігаційні кнопки */}
        {images.length > 1 && (
          <>
            <button
