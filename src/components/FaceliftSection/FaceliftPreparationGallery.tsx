...
export function FaceliftPreparationGallery({ images, galleryId }: FaceliftPreparationGalleryProps) {
  ...
  return (
    <div className="w-full mx-auto relative" id={galleryId}>
      <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[600px] bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl">
        {/* Навігаційні кнопки */}
        {images.length > 1 && (
          <>
            <button
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-44px)] sm:h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded">
          ...
          <Image
            src={
              currentImage.src || '/placeholder.svg?height=600&width=800&query=facelift preparation'
            }
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src ||
                  '/placeholder.svg?height=600&width=800&query=facelift preparation'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=facelift preparation thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
