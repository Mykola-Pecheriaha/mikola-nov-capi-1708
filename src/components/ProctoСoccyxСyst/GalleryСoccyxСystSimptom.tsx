...
export type GalleryСoccyxСystSimptomImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const simptomImages: GalleryСoccyxСystSimptomImage[] = [
  { src: "/images/procto/coccyxcyst/coccyxcyst6.jpg", alt: "Симптом кісти куприка 1", width: 800, height: 600, title: "Симптом 1" },
  { src: "/images/procto/coccyxcyst/coccyx4.jpg", alt: "Симптом кісти куприка 2", width: 800, height: 600, title: "Симптом 2" },
  { src: "/images/procto/coccyxcyst/coccyx11.jpg", alt: "Симптом кісти куприка 3", width: 800, height: 600, title: "Симптом 3" },
  { src: "/images/procto/coccyxcyst/coccyx1.jpg", alt: "Симптом кісти куприка 4", width: 800, height: 600, title: "Симптом 4" },
];

interface GalleryСoccyxСystSimptomProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryСoccyxСystSimptom({ className = "", style }: GalleryСoccyxСystSimptomProps) {
