...
export type GalleryСoccyxСystTerapiImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const terapiImages: GalleryСoccyxСystTerapiImage[] = [
  { src: "/images/procto/coccyxcyst/coccyxcyst9.jpg", alt: "Лікування кісти куприка 1", width: 800, height: 600, title: "Лікування 1" },
  { src: "/images/procto/coccyxcyst/coccyxcyst10.jpg", alt: "Лікування кісти куприка 2", width: 800, height: 600, title: "Лікування 2" },
  { src: "/images/procto/coccyxcyst/coccyx5.jpg", alt: "Лікування кісти куприка 3", width: 800, height: 600, title: "Лікування 3" },
  { src: "/images/procto/coccyxcyst/coccyx4.jpg", alt: "Лікування кісти куприка 4", width: 800, height: 600, title: "Лікування 4" },
  { src: "/images/procto/coccyxcyst/coccyxcyst15.jpg", alt: "Лікування кісти куприка 5", width: 800, height: 600, title: "Лікування 5" },
  { src: "/images/procto/coccyxcyst/coccyxcyst11.jpg", alt: "Лікування кісти куприка 6", width: 800, height: 600, title: "Лікування 6" },
];

interface GalleryСoccyxСystTerapiProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryСoccyxСystTerapi({ className = "", style }: GalleryСoccyxСystTerapiProps) {
