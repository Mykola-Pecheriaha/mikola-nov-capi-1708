...
export type GalleryPararectalFistulaDiagnosImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const diagnosImages: GalleryPararectalFistulaDiagnosImage[] = [
  { src: "/images/procto/pararectal-fistula/pararecta5.jpg", alt: "Діагностика нориці 1", width: 800, height: 600, title: "Діагностика 1" },
  { src: "/images/procto/pararectal-fistula/parafistula5.jpg", alt: "Діагностика нориці 2", width: 800, height: 600, title: "Діагностика 2" },
  { src: "/images/procto/pararectal-fistula/pararectal9.jpg", alt: "Діагностика нориці 3", width: 800, height: 600, title: "Діагностика 3" },
  { src: "/images/procto/pararectal-fistula/parafistula4.jpg", alt: "Діагностика нориці 4", width: 800, height: 600, title: "Діагностика 4" },
    { src: "/images/procto/pararectal-fistula/parafistula9.jpg", alt: "Діагностика нориці 4", width: 800, height: 600, title: "Діагностика 4" },
];

interface GalleryPararectalFistulaDiagnosProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryPararectalFistulaDiagnos({ className = "", style }: GalleryPararectalFistulaDiagnosProps) {
