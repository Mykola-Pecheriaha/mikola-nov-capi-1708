...
export type GalleryPararectalFistulaSimptomImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const simptomImages: GalleryPararectalFistulaSimptomImage[] = [
  { src: "/images/procto/pararectal-fistula/parafistula5.jpg", alt: "Симптоми параректальної нориці 1", width: 800, height: 600, title: "Симптом 1" },
  { src: "/images/procto/pararectal-fistula/parafistula6.jpg", alt: "Симптоми параректальної нориці 2", width: 800, height: 600, title: "Симптом 2" },
  { src: "/images/procto/pararectal-fistula/parafistula3.jpg", alt: "Симптоми параректальної нориці 3", width: 800, height: 600, title: "Симптом 3" },
  { src: "/images/procto/pararectal-fistula/parafistula4.jpg", alt: "Симптоми параректальної нориці 4", width: 800, height: 600, title: "Симптом 4" },
   { src: "/images/procto/pararectal-fistula/parafistula7.jpg", alt: "Симптоми параректальної нориці 4", width: 800, height: 600, title: "Симптом 4" },
];

interface GalleryPararectalFistulaSimptomProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryPararectalFistulaSimptom({ className = "", style }: GalleryPararectalFistulaSimptomProps) {
