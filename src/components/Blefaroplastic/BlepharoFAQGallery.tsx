...
export function BlepharoFAQGallery({ images }: BlepharoFAQGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-80 sm:h-96 md:h-[500px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-500 dark:text-gray-400 text-lg sm:text-xl">
  ...
  return (
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-64 sm:h-80 md:h-[400px] lg:h-[500px] bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl">
        {images.length > 1 && (
          <>
            <button
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-44px)] sm:h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded">
          ...
          <Image
            src={
              currentImage.src || '/placeholder.svg?height=600&width=800&query=blepharoplasty faq'
            }
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src ||
                  '/placeholder.svg?height=600&width=800&query=blepharoplasty faq'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=blepharoplasty faq thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
