...
export type GalleryHeandConsultImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryHeandConsultImage[] = [
  {
    src: "/images/hand/HendConsul.jpg",
    alt: "Консультація кистьового хірурга 1",
    width: 800,
    height: 600,
    title: "Консультація 1"
  },
  {
    src: "/images/hand/HendConsul2.jpg",
    alt: "Консультація кистьового хірурга 2",
    width: 800,
    height: 600,
    title: "Консультація 2"
  },
  {
    src: "/images/hand/HendConsul3.jpg",
    alt: "Консультація кистьового хірурга 3",
    width: 800,
    height: 600,
    title: "Консультація 3"
  },
  {
    src: "/images/hand/HendConsul4.jpg",
    alt: "Консультація кистьового хірурга 4",
    width: 800,
    height: 600,
    title: "Консультація 4"
  },
    {
    src: "/images/hand/HendConsul5.jpg",
    alt: "Консультація кистьового хірурга 4",
    width: 800,
    height: 600,
    title: "Консультація 4"
      ...
      {
    src: "/images/hand/HendConsul6.jpg",
    alt: "Консультація кистьового хірурга 4",
    width: 800,
    height: 600,
    title: "Консультація 4"
...
interface GalleryHeandConsultProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryHeandConsult({ className = "", style }: GalleryHeandConsultProps) {
...
export default GalleryHeandConsult
