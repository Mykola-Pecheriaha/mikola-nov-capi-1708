...
export type GalleryCommonDiseasHandImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryCommonDiseasHandImage[] = [
  {
    src: "/images/hand/common1.jpg",
    alt: "Захворювання кисті 1",
    width: 800,
    height: 600,
    title: "Контрактура Дюпюїтрена"
  },
  {
    src: "/images/hand/common2.jpg",
    alt: "Захворювання кисті 2",
    width: 800,
    height: 600,
    title: "Синдром де Кервена"
  },
  {
    src: "/images/hand/common4.jpg",
    alt: "Захворювання кисті 3",
    width: 800,
    height: 600,
    title: "Тендовагініт"
  },
  {
    src: "/images/hand/common5.jpg",
    alt: "Захворювання кисті 4",
    width: 800,
    height: 600,
    title: "Тунельні синдроми"
  },
  {
    src: "/images/hand/common7.jpg",
    alt: "Захворювання кисті 5",
    width: 800,
    height: 600,
    title: "Гігроми або ганглії"
  },
  {
    src: "/images/hand/common8.jpg",
    alt: "Захворювання кисті 6",
    width: 800,
    height: 600,
    title: "хвороба Нотта (вузлова тендовагініт)"
  },
  {
    src: "/images/hand/common9.jpg",
    alt: "Захворювання кисті 7",
    width: 800,
    height: 600,
    title: "Синдактилії"
  },
...
interface GalleryCommonDiseasHandProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryCommonDiseasHand: React.FC<GalleryCommonDiseasHandProps> = ({ className = "", style }) => {
...
export default GalleryCommonDiseasHand
