...
export type GalleryPerformingSurgeryImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryPerformingSurgeryImage[] = [
  {
    src: "/images/hand/surgery1.jpg",
    alt: "Операція на кисті 1",
    width: 800,
    height: 600,
    title: "Підготовка"
  },
  {
    src: "/images/hand/surgery2.jpg",
    alt: "Операція на кисті 2",
    width: 800,
    height: 600,
    title: "Знеболювання"
  },
  {
    src: "/images/hand/surgery3.jpg",
    alt: "Операція на кисті 3",
    width: 800,
    height: 600,
    title: "Хірургічне втручання"
  },
      {
    src: "/images/hand/surgery5.jpg",
    alt: "Операція на кисті 4",
    width: 800,
    height: 600,
    title: "Завершення операції"
  },
  {
    src: "/images/hand/surgery4.jpg",
    alt: "Операція на кисті 4",
    width: 800,
    height: 600,
    title: "Пов'язка"
...
interface GalleryPerformingSurgeryProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryPerformingSurgery: React.FC<GalleryPerformingSurgeryProps> = ({ className = "", style }) => {
...
export default GalleryPerformingSurgery
