...
export type GalleryPreoperativePreparationImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryPreoperativePreparationImage[] = [
  {
    src: "/images/hand/preop1.jpg",
    alt: "Діагностика кисті 1",
    width: 800,
    height: 600,
    title: "Огляд лікарем"
  },
  {
    src: "/images/hand/preop2.jpg",
    alt: "Діагностика кисті 2",
    width: 800,
    height: 600,
    title: "Рентгенографія"
  },
  {
    src: "/images/hand/preop3.jpg",
    alt: "Діагностика кисті 3",
    width: 800,
    height: 600,
    title: "УЗД"
  },
  {
    src: "/images/hand/preop4.jpg",
    alt: "Діагностика кисті 4",
    width: 800,
    height: 600,
    title: "КТ"
  },
  {
    src: "/images/hand/preop5.jpg",
    alt: "Діагностика кисті 5",
    width: 800,
    height: 600,
    title: "МРТ"
  },
    {
    src: "/images/hand/preop6.jpg",
    alt: "Діагностика кисті 6",
    width: 800,
    height: 600,
...
interface GalleryPreoperativePreparationProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryPreoperativePreparation: React.FC<GalleryPreoperativePreparationProps> = ({ className = "", style }) => {
...
export default GalleryPreoperativePreparation
