...
export type GalleryKarvenHandTreatmentImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryKarvenHandTreatmentImage[] = [
  {
    src: "/images/hand/karven-treat1.jpg",
    alt: "Лікування де Кервена 1",
    width: 800,
    height: 600,
    title: "Лікування 1"
  },
  {
    src: "/images/hand/karven-treat2.jpg",
    alt: "Лікування де Кервена 2",
    width: 800,
    height: 600,
    title: "Лікування 2"
  },
  {
    src: "/images/hand/karven-treat5.jpg",
    alt: "Лікування де Кервена 3",
    width: 800,
    height: 600,
    title: "Лікування 3"
  },
  {
    src: "/images/hand/karven-treat6.jpg",
    alt: "Лікування де Кервена 4",
    width: 800,
    height: 600,
    title: "Лікування 4"
  },
  {
    src: "/images/hand/karven-treat3.jpg",
    alt: "Лікування де Кервена 5",
    width: 800,
    height: 600,
    title: "Лікування 5"
  },
...
interface GalleryKarvenHandTreatmentProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryKarvenHandTreatment: React.FC<GalleryKarvenHandTreatmentProps> = ({ className = "", style }) => {
...
export default GalleryKarvenHandTreatment
