...
export type GalleryKarvenHandImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryKarvenHandImage[] = [
  {
    src: "/images/hand/karven1.jpg",
    alt: "Де Кервен 1",
    width: 800,
    height: 600,
    title: "біль та дискомфорт"
  },
  {
    src: "/images/hand/karven2.jpg",
    alt: "Де Кервен 2",
    width: 800,
    height: 600,
    title: "набряк та запалення навколо сухожилків"
  },
  {
    src: "/images/hand/karven3.jpg",
    alt: "Де Кервен 3",
    width: 800,
    height: 600,
    title: "скрип або тріскання під час руху"
  },
  {
    src: "/images/hand/karven4.jpg",
    alt: "Де Кервен 4",
    width: 800,
    height: 600,
    title: "УЗД для оцінки стану сухожилків"
  },
  {
    src: "/images/hand/karven5.jpg",
    alt: "Де Кервен 5",
    width: 800,
    height: 600,
    title: "УЗД для оцінки стану сухожилків"
    ...
    {
    src: "/images/hand/karven7.jpg",
    alt: "Де Кервен 5",
    width: 800,
    height: 600,
    title: "МРТ-кальцинозу"
  },
];

interface GalleryKarvenHandProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryKarvenHand: React.FC<GalleryKarvenHandProps> = ({ className = "", style }) => {
...
export default GalleryKarvenHand
