...
export type GalleryHandSurgLigamentumImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const images: GalleryHandSurgLigamentumImage[] = [
  {
    src: "/images/hand/ligamentum1.jpg",
    alt: "Ваші руки — наша турбота",
    width: 800,
    height: 600,
    title: "Ваші руки — наша турбота"
  },
  {
    src: "/images/hand/ligamentum2.jpg",
    alt: "Хірургія сухожилок 2",
    width: 800,
    height: 600,
    title: "Синдром де Кервена"
  },
  {
    src: "/images/hand/ligamentum3.jpg",
    alt: "Хірургія сухожилок 3",
    width: 800,
    height: 600,
    title: "хвороба Нотта"
  },
  {
    src: "/images/hand/common6.jpg",
    alt: "Хірургія сухожилок 4",
    width: 800,
    height: 600,
...
interface GalleryHandSurgLigamentumProps {
  className?: string;
  style?: React.CSSProperties;
}

const GalleryHandSurgLigamentum: React.FC<GalleryHandSurgLigamentumProps> = ({ className = "", style }) => {
...
export default GalleryHandSurgLigamentum
