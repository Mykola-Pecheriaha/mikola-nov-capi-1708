      ...
      <div className="w-full mb-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          ...
          <div className="text-blue-900 text-base">
            Зазвичай ендовазальна лазерна коагуляція проводиться у кілька етапів. Ось як лікують
            варикоз лазером:
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row bg-[#e7eeef] rounded-xl shadow p-6 gap-8 items-start">
        ...
        <div className="w-full lg:w-2/3 flex flex-col">
          ...
          <ol className="list-decimal list-inside space-y-3 text-blue-900 text-base font-medium mb-4">
            <li>
              Пацієнт лягає на операційний стіл. Лікар робить розмітку на шкірі під контролем УЗД —
              вказує місця з’єднання вени з притоками та зворотний потік крові.
            </li>
            <li>
              Пацієнту вводять знеболювальне. Флеболог проколює хвору судину і вставляє в неї
              катетер із лазером.
            </li>
            <li>
              Лікар обробляє тканини навколо вени місцевим анестетиком. Тому пацієнт не відчуває
              болю та впливу лазером на стінки судин.
            </li>
            <li>
              Лікар руйнує вену зсередини. Венозні стінки запаюються і перекривають доступ крові,
              тому потік крові на цій ділянці припиняється. Кров рухається іншими, здоровими венами.
            </li>
