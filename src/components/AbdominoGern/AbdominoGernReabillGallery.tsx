...
interface AbdominoGernReabillGalleryProps {
  images: GalleryImage[];
}

export function AbdominoGernReabillGallery({ images }: AbdominoGernReabillGalleryProps) {
...
export default AbdominoGernReabillGallery;
