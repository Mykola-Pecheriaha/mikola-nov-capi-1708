...
interface ButtockPreparationGalleryProps {
  images: GalleryImage[];
}

export function ButtockPreparationGallery({ images }: ButtockPreparationGalleryProps) {
    ...
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-blue-100 dark:border-blue-900">
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={currentImage.src || '/placeholder.svg?height=600&width=800&query=preparation'}
...
export default ButtockPreparationGallery;
