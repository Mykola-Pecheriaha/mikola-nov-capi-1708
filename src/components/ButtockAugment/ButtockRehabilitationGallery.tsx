...
interface ButtockRehabilitationGalleryProps {
  images: GalleryImage[];
}

export function ButtockRehabilitationGallery({ images }: ButtockRehabilitationGalleryProps) {
      ...
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md">
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=buttock+rehabilitation'
            }
              ...
              <div className="absolute bottom-5 left-0 right-0 flex justify-center gap-2 sm:gap-3 p-3 bg-black/60 overflow-x-auto">
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src || '/placeholder.svg?height=75&width=100&query=buttock+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default ButtockRehabilitationGallery;
