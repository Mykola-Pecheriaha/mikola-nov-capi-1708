...
interface ImplantBreastReabilitGalleryProps {
  images: ImageType[];
}

export function ImplantBreastReabilitGallery({ images }: ImplantBreastReabilitGalleryProps) {
...
export default ImplantBreastReabilitGallery;
