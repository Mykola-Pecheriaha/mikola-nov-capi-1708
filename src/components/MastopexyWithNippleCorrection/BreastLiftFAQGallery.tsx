    ...
    <div className="w-full mx-auto relative">
      ...
      >
        ...
        {images.length > 1 && (
          <>
            <button
              className="absolute top-1/2 left-4 -translate-y-1/2 w-9 h-9 bg-white/20 dark:bg-gray-700/20 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md hover:scale-110"
              style={{ color: '#8EAAB8' }}
              onMouseEnter={(e) =>
            ...
            <button
              className="absolute top-1/2 right-4 -translate-y-1/2 w-9 h-9 bg-white/20 dark:bg-gray-700/20 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md hover:scale-110"
              style={{ color: '#8EAAB8' }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = 'rgba(142, 170, 184, 0.8)')
              }
              ...
              <>
                ...
                <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
                  <Image
                    src={
                      currentImage.src ||
                      '/placeholder.svg?height=600&width=400&query=breast+lift+faq'
                    }
                    alt={currentImage.alt}
                    width={currentImage.width}
                    height={currentImage.height}
