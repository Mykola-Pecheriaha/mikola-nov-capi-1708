...
interface BreastContraIndicationsGalleryProps {
  images: GalleryImage[];
}

export function BreastContraIndicationsGallery({ images }: BreastContraIndicationsGalleryProps) {
    ...
    <div className="w-full mx-auto relative">
      ...
      >
        ...
        {images.length > 1 && (
          <>
            <button
              className="absolute top-1/2 left-4 -translate-y-1/2 w-9 h-9 bg-white/20 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md hover:scale-110"
              style={{ color: '#8EAAB8' }}
              onMouseEnter={(e) =>
            ...
            <button
              className="absolute top-1/2 right-4 -translate-y-1/2 w-9 h-9 bg-white/20 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md hover:scale-110"
              style={{ color: '#8EAAB8' }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = 'rgba(142, 170, 184, 0.8)')
              }
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={
              currentImage.src || '/placeholder.svg?height=600&width=400&query=contraindications'
            }
        ...
        >
          ...
          <button
            className="w-7 h-7 bg-transparent rounded flex items-center justify-center text-base cursor-pointer transition-all duration-300 font-bold border"
            style={{ borderColor: '#8EAAB8', color: '#8EAAB8' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#8EAAB8';
              e.currentTarget.style.color = '#ffffff';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = 'transparent';
              e.currentTarget.style.color = '#8EAAB8';
            }}
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src ||
                  '/placeholder.svg?height=600&width=400&query=contraindications'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=contraindications+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BreastContraIndicationsGallery;
