...
interface BreastIndicationGalleryProps {
  images: GalleryImage[];
}

export function BreastIndicationGallery({ images }: BreastIndicationGalleryProps) {
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=breast+lift+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BreastIndicationGallery;
