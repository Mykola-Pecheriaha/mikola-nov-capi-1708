...
export function MastopexyInfoGallery({ images }: MastopexyInfoGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-[350px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 text-xl">
  ...
  return (
    <div className="w-full mx-auto relative">
      <div
        className="relative w-full h-[350px] bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border"
        ...
        >
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src || '/placeholder.svg?height=600&width=400&query=mastopexy+info'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=mastopexy+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
