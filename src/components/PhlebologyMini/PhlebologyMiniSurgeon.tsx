      ...
      <div className="w-full mb-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          ...
          <div className="text-blue-900 text-base">
            Мініфлебектомія – це операція з видалення розширених вен через невеликі проколи.
            Застосовується для лікування варикозної хвороби та дає ефективні результати. Суть методу
            полягає в тому, що після видалення розширених вен кровотік відновлюється за рахунок
            здорових.
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row bg-[#e7eeef] rounded-xl shadow p-6 gap-8 items-start">
        ...
        <div className="w-full lg:w-2/3 flex flex-col">
          ...
          <ul className="list-disc list-inside space-y-3 text-blue-900 text-base font-medium mb-4">
            <li>
              Швидкий та якісний результат, причому ефект одержують як лікувальний, так і
              естетичний;
            </li>
            ...
            <li>
              Зважаючи на місцеве знеболювання, є можливість проводити маніпуляцію навіть із
              протипоказаннями для загального наркозу;
            </li>
