...
export function GinecomastiyaFAQGallery({ images }: GinecomastiyaFAQGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-96 md:h-[500px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 text-xl border border-gray-300 dark:border-gray-600">
  ...
  return (
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 md:h-[500px] bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-300 dark:border-gray-600">
        {/* Навігаційні кнопки */}
        {images.length > 1 && (
          <>
            <button
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src ||
                  '/placeholder.svg?height=600&width=800&query=gynecomastia+faq+fullscreen'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=gynecomastia+faq+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
