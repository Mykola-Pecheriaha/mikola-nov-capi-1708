...
interface GinecomastiyaIndicationsGalleryProps {
  images: GalleryImage[];
}

export function GinecomastiyaIndicationsGallery({ images }: GinecomastiyaIndicationsGalleryProps) {
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=гінекомастія+мініатюра'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default GinecomastiyaIndicationsGallery;
