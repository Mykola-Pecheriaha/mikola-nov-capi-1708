...
interface DermScarCorrectionDetailsGalleryProps {
  images: GalleryImage[];
}

export function DermScarCorrectionDetailsGallery({
  images,
}: DermScarCorrectionDetailsGalleryProps) {
  ...
  return (
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md">
        {/* Навігаційні кнопки */}
        {images.length > 1 && (
          <>
            <button
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={currentImage.src || '/placeholder.svg?height=600&width=800&query=derm-correction'}
        ...
        >
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src || '/placeholder.svg?height=600&width=800&query=derm-correction'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
...
export default DermScarCorrectionDetailsGallery;
