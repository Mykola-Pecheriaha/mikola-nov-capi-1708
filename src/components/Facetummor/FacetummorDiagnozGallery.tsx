...
interface FacetummorDiagnozGalleryProps {
  images?: GalleryImage[];
}

export function FacetummorDiagnozGallery({
  images = defaultImages,
}: FacetummorDiagnozGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-96 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 text-lg border border-blue-100 dark:border-blue-900 transition-colors duration-300">
...
export default FacetummorDiagnozGallery;
