...
interface FacetummorDetalisGalleryProps {
  images: GalleryImage[];
}

export function FacetummorDetalisGallery({ images }: FacetummorDetalisGalleryProps) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-96 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 text-xl border border-gray-300 dark:border-gray-700 transition-colors duration-300">
  ...
  return (
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg dark:shadow-xl border border-blue-100 dark:border-blue-900 transition-colors duration-300">
        {/* Навігаційні кнопки */}
        {images.length > 1 && (
          <>
            <button
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={currentImage.src || '/placeholder.svg?height=600&width=800&query=facetumor'}
        ...
        {/* Нижня панель */}
        <div className="absolute bottom-0 left-0 right-0 h-11 bg-white dark:bg-gray-800 flex items-center justify-between px-4 z-[2] border-t border-blue-100 dark:border-blue-900 transition-colors duration-300">
            ...
            {showThumbnails && (
              <div className="absolute bottom-5 left-0 right-0 flex justify-center gap-2 sm:gap-3 p-3 bg-black/60 overflow-x-auto">
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image.src || '/placeholder.svg?height=75&width=100&query=thumbnail'}
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default FacetummorDetalisGallery;
