...
const images = [
  { src: "/images/hand/carpal/carpale2.jpg", alt: "Карпальний синдром 1", width: 800, height: 600, title: "Зображення 1" },
  { src: "/images/hand/carpal/carpal6.jpg", alt: "Карпальний синдром 2", width: 800, height: 600, title: "Зображення 2" },
  { src: "/images/hand/carpal/carpale5.jpg", alt: "Карпальний синдром 3", width: 800, height: 600, title: "Зображення 3" },

];

const StartCarpalSyndromeGallery = ({ className = "", style }: { className?: string; style?: React.CSSProperties }) => {
...
export default StartCarpalSyndromeGallery;
