...
const images = [
  { src: "/images/hand/carpale-details/carpale15.jpg", alt: "Карпальний синдром 1", width: 800, height: 600, title: "Зображення 1" },
  { src: "/images/hand/carpale-details/carpal8.jpg", alt: "Карпальний синдром 2", width: 800, height: 600, title: "Зображення 2" },
  { src: "/images/hand/carpale-details/carpale1.jpg", alt: "Карпальний синдром 3", width: 800, height: 600, title: "Зображення 3" },
  { src: "/images/hand/carpale-details/carpale3.jpg", alt: "Карпальний синдром 4", width: 800, height: 600, title: "Зображення 4" },

];

const GalleryCarpalDetails = ({ className = "", style }: { className?: string; style?: React.CSSProperties }) => {
...
export default GalleryCarpalDetails;
