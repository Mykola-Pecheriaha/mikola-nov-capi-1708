...
interface CervicalHumpIndicatioGalleryProps {
  images: GalleryImage[];
}

export function CervicalHumpIndicatioGallery({ images }: CervicalHumpIndicatioGalleryProps) {
    ...
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-blue-100 dark:border-blue-900">
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] mx-1 my-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={currentImage.src || '/placeholder.svg?height=600&width=800&query=cervical+hump'}
        ...
        >
          ...
          >
            ...
            <div className="relative w-4/5 h-4/5 flex flex-col items-center justify-center">
              <Image
                src={
                  currentImage.src || '/placeholder.svg?height=600&width=800&query=cervical+hump'
                }
                alt={currentImage.alt}
                width={currentImage.width}
                height={currentImage.height}
                ...
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=cervical+hump+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default CervicalHumpIndicatioGallery;
