          ...
          {problemsData.map((problem) => {
            ...
            return (
              ...
              >
                {/* Заголовок акордеона */}
                <button
                  className="w-full bg-transparent border-none p-4 md:p-6 cursor-pointer flex items-center justify-between text-left transition-colors duration-300 hover:bg-blue-50"
                  onClick={() => toggleSection(problem.id)}
                  aria-expanded={isExpanded}
                >
                  <h3 className="text-base md:text-xl font-semibold text-gray-800 flex-1 leading-snug pr-4">
                    {problem.title}
                  </h3>
                  <div className="text-blue-500 transition-transform duration-300 flex-shrink-0">
