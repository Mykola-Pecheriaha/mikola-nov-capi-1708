...
const PreparationGallery: React.FC<PreparationGalleryProps> = ({ images }) => {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="w-full h-[300px] sm:h-[350px] md:h-[400px] flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded-lg text-gray-600 dark:text-gray-300 text-base sm:text-lg">
      ...
      <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl">
        ...
        <div className="relative w-full h-[calc(100%-44px)] sm:h-[calc(100%-48px)] overflow-hidden">
          {!imagesLoaded[currentIndex] && (
            <div className="absolute inset-0 flex items-center justify-center bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm sm:text-base">
              Завантаження...
            </div>
          )}
          <Image
