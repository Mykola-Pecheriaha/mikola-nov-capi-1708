        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 mb-12 md:mb-16">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-xl overflow-hidden shadow-lg">
              <Image
                src="/images/plastic-surgery/breast-augmentation.jpg"
        ...
        <div className="w-full max-w-5xl mx-auto space-y-6 md:space-y-8">
          ...
          >
            <p className="leading-relaxed">
              ...
              Збільшення грудей (мамопластика) — це сучасна хірургічна процедура, що дозволяє
              досягти бажаного об&apos;єму та форми грудей за допомогою високоякісних імплантатів.
              Завдяки новітнім технологіям і матеріалам результат виглядає максимально природно та
          ...
          >
            <p className="leading-relaxed">
              <span className="text-xl md:text-2xl mr-2">⇒</span>
              Ми застосовуємо індивідуальний підхід до кожної пацієнтки, враховуючи її анатомічні
              особливості, побажання та спосіб життя, щоб досягти найкращого естетичного результату.
              У своїй роботі використовуємо лише сучасні імплантати, які забезпечують природний
              вигляд і комфортні відчуття. Особливу увагу приділяємо безпеці пацієнтки та зведенню
              до мінімуму періоду відновлення.
            </p>
          </div>
          ...
          >
            <p className="leading-relaxed">
              <span className="text-xl md:text-2xl mr-2">⇒</span>
              Перед операцією проводиться детальна консультація, під час якої хірург разом із
              пацієнткою підбирає оптимальний розмір, форму й тип імплантатів, а також обговорюються
              всі аспекти процедури та відновлення. Наша мета — не лише покращити зовнішність, а й
              підвищити впевненість у собі та якість життя кожної жінки.
            </p>
          </div>
        </div>
      </div>
