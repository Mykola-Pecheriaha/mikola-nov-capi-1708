    ...
    <section className="w-full flex flex-col gap-8 md:gap-10 py-8 px-2 md:px-8">
      ...
      <div className="w-full mb-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          <span className="mt-1 text-blue-400 text-2xl">ℹ️</span>
          <div className="text-blue-900 text-base">
            <span className="font-bold">Прийом у цього лікаря, як правило, на першому етапі полягає в огляді та розшифровці аналізів (простіше кажучи, консультації).

Зазвичай при первинній консультації хірург оглядає пацієнта, вислуховує його скарги.

Тому постарайтеся коротко викласти всю історію своєї хвороби: перші симптоми, болючі відчуття. Так Ваш візит стане ще результативнішим. За потреби хірург може направити пацієнта на додаткове обстеження: аналізи, рентгени, консультації інших фахівців.

Також лікареві знадобляться дані про попередні обстеження та аналізи (якщо такі є), про спадкові схильності, алергічні реакції, спосіб життя.</span>
          </div>
        </div>
      </div>
    </section>
