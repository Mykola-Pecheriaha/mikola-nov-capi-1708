          ...
          <div className="flex-1 md:flex-[2] bg-white rounded-lg shadow-lg p-8 flex flex-col justify-between min-h-[400px]">
            <div>
              ...
              <p className="text-gray-600 text-base md:text-lg mb-8">
                Амбулаторна та хірургія одного дня — швидке й безпечне лікування без потреби
                тривалої госпіталізації. Сучасні методи дозволяють ефективно усунути доброякісні
                утворення, врослі нігті та запальні процеси шкіри.
              </p>
            </div>
            <button
              ...
              onClick={() => router.push('/services/ambulatory-surgery')}
            >
              Дізнатися більше
            </button>
          </div>
