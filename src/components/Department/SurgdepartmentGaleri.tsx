...
const SurgdepartmentGaleri: React.FC = () => {
    ...
    return (
      <section className="w-full bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-8 md:py-12">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-blue-900 dark:text-blue-100 mb-12 md:mb-16">
            Галерея хірургічного відділення
          </h2>
  ...
  return (
    <section className="w-full bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        {/* Заголовок */}
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-blue-900 dark:text-blue-100 mb-8 md:mb-12">
          Галерея хірургічного відділення
        </h2>
...
export default SurgdepartmentGaleri;
