    ...
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-blue-100 dark:border-blue-900">
        ...
        {images.length > 1 && (
          <>
            <button
              className="absolute top-1/2 left-4 -translate-y-1/2 w-9 h-9 bg-white/20 hover:bg-white/100 dark:bg-gray-700/30 dark:hover:bg-gray-700/50 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 text-blue-600 dark:text-blue-400 shadow-md hover:scale-110"
              onClick={prevImage}
            ...
            <button
              className="absolute top-1/2 right-4 -translate-y-1/2 w-9 h-9 bg-white/20 hover:bg-white/100 dark:bg-gray-700/30 dark:hover:bg-gray-700/50 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 text-blue-600 dark:text-blue-400 shadow-md hover:scale-110"
              onClick={nextImage}
