...
function ImplantBreastReabilitGallery({ images }: ImplantBreastReabilitGalleryProps) {
    ...
    <div className="w-full mx-auto relative">
      ...
      >
        ...
        <div className="relative w-[calc(100%-8px)] h-[calc(100%-48px)] m-1 mb-11 overflow-hidden rounded-lg">
          ...
          <Image
            src={currentImage.src || '/placeholder.svg?height=600&width=800&query=breast+recovery'}
              ...
              <>
                ...
                <div className="relative w-4/5 h-4/5 flex items-center justify-center">
                  <Image
                    src={
                      currentImage.src ||
                      '/placeholder.svg?height=600&width=800&query=breast+recovery'
                    }
                    alt={currentImage.alt}
                    width={currentImage.width}
                    height={currentImage.height}
              ...
              <div className="absolute bottom-5 left-0 right-0 flex justify-center gap-2.5 p-2.5 bg-black/60 overflow-x-auto">
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src || '/placeholder.svg?height=75&width=100&query=recovery+thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
