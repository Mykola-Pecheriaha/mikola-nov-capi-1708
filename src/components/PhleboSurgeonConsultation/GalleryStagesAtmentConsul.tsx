...
export type GalleryStagesAtmentConsulImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
// Масив зображень для галереї стадій (8 шт)
const stagesImages: GalleryStagesAtmentConsulImage[] = [
  {
...
interface GalleryStagesAtmentConsulProps {
  className?: string;
  style?: React.CSSProperties;
}

export default function GalleryStagesAtmentConsul({ className = "", style }: GalleryStagesAtmentConsulProps) {
