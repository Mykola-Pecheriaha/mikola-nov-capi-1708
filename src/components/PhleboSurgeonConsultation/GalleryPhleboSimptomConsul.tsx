...
export type GalleryPhleboSimptomConsulImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const simptomImages: GalleryPhleboSimptomConsulImage[] = [
  {
    src: "/images/varicose/simptom/simptom1.jpg",
    alt: "Симптом 1",
    width: 800,
    height: 600,
    title: "Симптом 1"
...
interface GalleryPhleboSimptomConsulProps {
  className?: string;
  style?: React.CSSProperties;
}

export default function GalleryPhleboSimptomConsul({ className = "", style }: GalleryPhleboSimptomConsulProps) {
