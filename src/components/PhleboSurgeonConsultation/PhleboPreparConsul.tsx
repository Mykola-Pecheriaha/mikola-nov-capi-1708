  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl mb-8">
        ...
        >
          Перед проведенням операції необхідно пройти обстеження у хірурга, що включає загальний
          огляд та УЗД вен нижніх кінцівок. Діагностика виявить патологічні зміни у венах, допоможе
          визначити потрібний обсяг оперативного лікування. Після цього призначають дату проведення
          операції та додаткові аналізи та дослідження:
        </div>
      </div>
      <div className="flex flex-col lg:flex-row w-full max-w-5xl gap-8 items-start">
        <div className="w-full lg:w-2/3">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              біохімічний аналіз крові (печінкові проби, вимірювання рівня креатиніну та сечовини);
            </li>
