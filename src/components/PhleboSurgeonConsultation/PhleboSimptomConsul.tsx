  ...
  return (
    <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full lg:w-2/3">
          <section className="mb-6">
            <p className="mb-2 font-medium">
              Зазвичай ранні стадії варикозної хвороби протікають майже непомітно. Проте з часом
              можуть з’являтися характерні симптоми:
            </p>
            <ul className="pl-0">
              ...
              <li className="mb-2 text-blue-900 font-semibold">
              ...
              <li className="mb-2 text-blue-900 font-semibold">
                - Зміни шкіри –{' '}
                <span className="font-normal">сухість, потемніння, втрата еластичності</span>
              </li>
              <li className="mb-2 text-blue-900 font-semibold">
                - Видимі вени –{' '}
                <span className="font-normal">покручені, видовжені, з часом утворюють вузлики</span>
              </li>
            </ul>
          </section>
        </div>
      ...
      <div className="w-full max-w-5xl mt-8">
        ...
        >
          При перших проявах варикозу варто звернутися до лікаря, який надасть вичерпну інформацію
          щодо вашого стану, можливих ускладнень та призначить лікування.
          <br />
          <span className="font-bold">Пам’ятайте!</span> Вчасне звернення до лікаря зменшує ризик
