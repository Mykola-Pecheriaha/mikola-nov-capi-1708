...
export type GalleryPhleboReabilConsulImage = {
	src: string;
	alt: string;
	width: number;
	height: number;
...
const reabilImages: GalleryPhleboReabilConsulImage[] = [
	{
		src: "/images/varicose/reabiblit/phleboConsult6.jpg",
		alt: "Реабілітація 1",
		width: 800,
		height: 600,
...
export default function GalleryPhleboReabilConsul({ className = "", style }: { className?: string; style?: React.CSSProperties } = {}) {
