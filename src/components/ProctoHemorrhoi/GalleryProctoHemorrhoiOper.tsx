...
export type GalleryProctoHemorrhoiOperImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const operImages: GalleryProctoHemorrhoiOperImage[] = [
  { src: "/images/procto/hemorroi/hemorroi28.jpg", alt: "Оперативне лікування 1", width: 800, height: 600, title: "Міллігана–Моргана" },
  { src: "/images/procto/hemorroi/hemorroi30.jpg", alt: "Оперативне лікування 2", width: 800, height: 600, title: "операція Лонґо" },
  { src: "/images/procto/hemorroi/hemorroi29.jpg", alt: "Оперативне лікування 3", width: 800, height: 600, title: "Перев’язка гемороїдальних артерій" },
  { src: "/images/procto/hemorroi/hemorroi32.jpg", alt: "Оперативне лікування 4", width: 800, height: 600, title: "(HAL-RAR метод" },
    { src: "/images/procto/hemorroi/hemorroi33.jpg", alt: "Оперативне лікування 4", width: 800, height: 600, title: "(HAL-RAR метод" },
  { src: "/images/procto/hemorroi/hemorroi31.jpg", alt: "Оперативне лікування 4", width: 800, height: 600, title: "Лазерна гемороїдектомія" },
];

interface GalleryProctoHemorrhoiOperProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryProctoHemorrhoiOper({ className = "", style }: GalleryProctoHemorrhoiOperProps) {
