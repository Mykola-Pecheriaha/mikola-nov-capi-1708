...
export type GalleryProctoHemorrhoiTerapiImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
// Масив зображень для галереї консервативного лікування (4 шт)
const terapiImages: GalleryProctoHemorrhoiTerapiImage[] = [
  { src: "/images/procto/hemorroi/hemorroi18.jpg", alt: "Медикаментозне лікування", width: 800, height: 600, title: "Медикаментозне лікування" },
  { src: "/images/procto/hemorroi/hemorroi22.jpg", alt: "Лігування гумовою стрічкою (бандажування)", width: 800, height: 600, title: "Лігування гумовою стрічкою (бандажування)" },
  { src: "/images/procto/hemorroi/hemorroi24.jpg", alt: "Склеротерапія.", width: 800, height: 600, title: "Склеротерапія." },
  { src: "/images/procto/hemorroi/hemorroi25.jpg", alt: "Електротерапія", width: 800, height: 600, title: "Електротерапія" },
    { src: "/images/procto/hemorroi/hemorroi27.jpg", alt: "Інфрачервона коагуляція.", width: 800, height: 600, title: "Інфрачервона коагуляція." },
];

interface GalleryProctoHemorrhoiTerapiProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryProctoHemorrhoiTerapi({ className = "", style }: GalleryProctoHemorrhoiTerapiProps) {
