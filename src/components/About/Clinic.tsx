...
const Clinic: React.FC = () => {
  ...
  const galleryImages: GalleryImage[] = [
    ...
    {
      src: '/images/surgical-department/surgdepartm8.jpg',
      alt: 'Хірургічна лікарня',
      width: 800,
      height: 600,
      title: 'Хірургічне відділення',
    },
    {
      src: '/images/surgical-department/surgdepartm9.jpg',
    ...
    {
      src: '/images/surgical-department/surgdepartm12.jpg',
    ...
    {
      src: '/images/surgical-department/surgdepartm13.jpg',
      alt: 'Палата для пацієнтів',
      width: 800,
      height: 600,
      title: 'Палата для пацієнтів',
    },
    {
      ...
      width: 800,
      height: 600,
      title: 'Клінічне середовище',
    },
    {
      src: '/images/surgical-department/surgdepartm15.jpg',
    ...
    },
    {
      ...
      alt: 'Лікувальне відділення',
      width: 800,
      height: 600,
      title: 'Лікувальне відділення',
    },
    {
      src: '/images/surgical-department/surgdepartm17.jpg',
    ...
    {
      src: '/images/surgical-department/surgdepartm18.jpg',
      alt: 'Устаткування клініки',
      width: 800,
      height: 600,
    ...
    },
    {
      ...
      alt: 'Клінічні приміщення',
      width: 800,
      height: 600,
      title: 'Клінічні приміщення',
    },
  ];
  ...
  return (
    <section className="w-full bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        {/* Заголовок */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-blue-900 dark:text-blue-100 mb-8 md:mb-12">
          Клініка де оперує хірург
        </h1>
        ...
        <div className="w-full max-w-4xl mx-auto mb-12">
          <div className="bg-blue-50 dark:bg-gray-800 rounded-xl p-6 md:p-8 shadow-lg border-l-4 border-blue-500">
            <p className="text-base md:text-lg text-gray-800 dark:text-gray-300 leading-relaxed text-justify mb-4">
              <span className="font-bold text-blue-900 dark:text-blue-300">
                Наша клініка оснащена найсучаснішим медичним обладнанням та технологіями
              </span>
              , що дозволяє нам проводити складні хірургічні втручання на найвищому рівні. Ми
              гордимся нашою командою висококваліфікованих фахівців, які завжди готові надати
              найкращу медичну допомогу.
            </p>
            <p className="text-base md:text-lg text-gray-800 dark:text-gray-300 leading-relaxed text-justify">
              Кожна операційна оснащена сучасним обладнанням для моніторингу пацієнта, стерилізації
              інструментів та безпечного проведення всіх видів хірургічних втручань. Комфорт та
              безпека пацієнтів – наш пріоритет.
            </p>
          </div>
        </div>
