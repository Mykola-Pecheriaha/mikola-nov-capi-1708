...
const breastServices: ServiceCard[] = [
  {
    id: 'breast-augmentation',
    title: 'Збільшення грудей',
    description: 'Операція з імплантами для збільшення розміру та поліпшення форми грудей',
    coverImage: '/images/services/cartca5.jpg',
    href: '/services/breast-augmentation',
  },
  {
    id: 'breast-lift',
    title: 'Підтяжка грудей і корекція соска',
    description: 'Мастопексія для відновлення форми та корекція сосково-ареолярного комплексу',
    coverImage: '/images/services/plastychna-khirurhiy.jpg',
  ...
  },
  {
    ...
    description:
      'Реендопротезування та видалення грудних імплантів за естетичними та медичними показами',
    coverImage: '/images/services/3breast.jpg',
    href: '/services/removal-replacement-implants',
  },
  {
    id: 'gynecomastia',
    title: 'Гінекомастія',
    description: 'Корекція збільшення грудних залоз у чоловіків для відновлення чоловічого силуету',
    coverImage: '/images/services/ginecomas2.jpg',
    href: '/services/gynecomastia',
  },
];

export default function BreastPlasticSurgery() {
  return (
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Сучасні методики пластичної хірургії грудей для досягнення гармонійних пропорцій та
            природної краси. Виберіть відповідну процедуру для детальної інформації.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Багаторічний досвід успішних операцій
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-3 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
