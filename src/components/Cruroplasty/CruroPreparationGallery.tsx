...
interface CruroPreparationGalleryProps {
  images: GalleryImage[];
}

export function CruroPreparationGallery({ images }: CruroPreparationGalleryProps) {
    ...
    <div className="w-full mx-auto relative">
      <div className="relative w-full h-96 bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md border border-gray-300 dark:border-gray-600">
        ...
        {images.length > 1 && (
          <>
            <button
              className="absolute top-1/2 left-4 -translate-y-1/2 w-9 h-9 bg-white/20 hover:bg-white/30 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md text-white hover:scale-110"
              onClick={prevImage}
            ...
            <button
              className="absolute top-1/2 right-4 -translate-y-1/2 w-9 h-9 bg-white/20 hover:bg-white/30 border-none rounded-full flex items-center justify-center text-lg cursor-pointer transition-all duration-300 z-10 shadow-md text-white hover:scale-110"
              onClick={nextImage}
...
export default CruroPreparationGallery;
