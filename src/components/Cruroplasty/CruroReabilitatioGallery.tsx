...
interface CruroReabilitatioGalleryProps {
  images: GalleryImage[];
}

export function CruroReabilitatioGallery({ images }: CruroReabilitatioGalleryProps) {
...
export default CruroReabilitatioGallery;
