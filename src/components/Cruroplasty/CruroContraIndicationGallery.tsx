...
interface CruroContraIndicationGalleryProps {
  images: GalleryImage[];
}

export function CruroContraIndicationGallery({ images }: CruroContraIndicationGalleryProps) {
...
export default CruroContraIndicationGallery;
