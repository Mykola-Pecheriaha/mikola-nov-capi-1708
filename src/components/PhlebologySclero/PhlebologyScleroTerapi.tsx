      ...
      <div className="w-full mb-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          ...
          <div className="text-blue-900 text-base">
            Склеротерапія – це нехірургічний метод лікування варикозу, який полягає в введенні
            спеціальної речовини, відомої як склерозуюча агент, безпосередньо в пошкоджені вени. Цей
            агент призводить до “склеювання” стінок пошкоджених вен, що призводить до їх зникнення
      ...
      <div className="flex flex-col lg:flex-row bg-[#e7eeef] rounded-xl shadow p-6 gap-8 items-start">
        ...
        <div className="w-full lg:w-2/3 flex flex-col">
          <ul className="list-disc list-inside space-y-3 text-blue-900 text-base font-medium mb-4">
            ...
            <li>
              безпека – біоклей не викликає алергії або інших ускладнень, а згодом повністю
              розсмоктується, як і склеєна вена;
            </li>
            <li>
              безболісність – не потрібен наркоз або складна анестезія, знеболюють тільки місце
              проколу;
            </li>
            <li>естетичність результату – відсутні шви, шрами або інші пошкодження шкіри;</li>
            <li>
              відсутність періоду реабілітації – не потрібно носити компресійні панчохи або
              дотримуватися інших обмежень;
            </li>
