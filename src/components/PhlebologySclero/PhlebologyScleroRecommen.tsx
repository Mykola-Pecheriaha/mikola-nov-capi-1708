    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="w-full mb-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          ...
          <div className="text-blue-900 text-base">
            Відразу після процедури пацієнту замотують ноги еластичним бинтом – його не можна
            знімати 2-3 дні. Щойно сеанс завершився, потрібно походити у швидкому темпі 40-60 хвилин
            – це посилить компресію.
            <br />
            <br />
            Після того, як пацієнту провели видалення вен (склеротерапія), йому потрібний час на
            реабілітацію. Її терміни залежить від ступеню важкості захворювання та особливостей
            організму. В одних цей процес займає 2-3 тижні, в інших – до 2 місяців. Щоб відновлення
            пройшло успішно, рекомендується:
          </div>
        </div>
      </div>
      ...
      <div className="w-full mt-8">
        <div className="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-5 flex gap-4 items-start shadow">
          ...
          <div className="text-blue-900 text-base">
            Якщо не дотримуватись цих рекомендацій після склеротерапії, наслідки можуть бути
            серйозними. На шкірі у місці уколів може утворитися гіперпігментація, запальний процес
            чи некроз. Також можливі тромбози та інші ускладнення.
          </div>
        </div>
      </div>
    </div>
