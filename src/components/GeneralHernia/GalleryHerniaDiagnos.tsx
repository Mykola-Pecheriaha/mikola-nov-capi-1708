...
export type GalleryHerniaDiagnosImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const diagnosImages: GalleryHerniaDiagnosImage[] = [
  { src: "/images/general-hernia/gerniya14.jpg", alt: "Покази до операції 1", width: 800, height: 600, title: "Покази 1" },
  { src: "/images/general-hernia/gerniyaDetalis26.jpg", alt: "Покази до операції 2", width: 800, height: 600, title: "Покази 2" },
  { src: "/images/general-hernia/gerniyaDetalis28.jpg", alt: "Покази до операції 3", width: 800, height: 600, title: "Покази 3" },
  { src: "/images/general-hernia/gerniyaDetalis28.jpg", alt: "Покази до операції 4", width: 800, height: 600, title: "Покази 4" },
  { src: "/images/general-hernia/gerniyaDetalis29.jpg", alt: "Покази до операції 5", width: 800, height: 600, title: "Покази 5" },
  { src: "/images/general-hernia/gerniyaDetalis29.jpg", alt: "Покази до операції 6", width: 800, height: 600, title: "Покази 6" },
  { src: "/images/general-hernia/gerniyaDetalis30.jpg", alt: "Покази до операції 7", width: 800, height: 600, title: "Покази 7" },

];

interface GalleryHerniaDiagnosProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryHerniaDiagnos({ className = "", style }: GalleryHerniaDiagnosProps) {
