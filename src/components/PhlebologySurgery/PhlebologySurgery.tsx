...
const phlebologyServices: ServiceCard[] = [
  {
    id: 'phlebology-consultation',
    title: 'Консультація хірурга',
    description:
      'Первинна консультація з флебологом для діагностики венозних захворювань та обговорення плану лікування',
    coverImage: '/images/services/varicos12.jpg',
    href: '/services/phlebology',
  },
  {
    id: 'laser-vein-removal',
    title: 'Лазерне видалення вен',
    description:
      'Сучасний мініінвазивний метод лікування варикозу за допомогою лазерної коагуляції судин',
    coverImage: '/images/services/laser1.jpg',
    href: '/services/phlebology-laser',
  },
  {
    id: 'miniphlebectomy',
    title: 'Мініфлебектомія',
    description:
      'Малотравматичне видалення варикозних вен через мікроскопічні надрізи з мінімальними рубцями',
    coverImage: '/images/services/miniadvant1.jpg',
    href: '/services/phlebology-miniphlebectomy',
  },
  {
    id: 'sclerotherapy',
    title: 'Склеротерапія',
    description:
      'Інвазивна процедура введення спеціального розчину в вени для їх закриття та видалення',
    coverImage: '/images/services/scleroter10.jpg',
    href: '/services/phlebology-sclerotherapy',
  },
];

export default function PhlebologySurgery() {
  return (
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Сучасні методики лікування варикозу та інших венозних захворювань ніг. Виберіть
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
          {phlebologyServices.map((service) => (
            <Link
              key={service.id}
              href={service.href}
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden bg-gradient-to-br from-blue-100 to-blue-50 dark:from-gray-700 dark:to-gray-600">
                <Image
                  ...
                  onError={(e) => {
                    e.currentTarget.src = '/placeholder.svg?height=256&width=256&query=vein';
                  }}
                />
                {/* Gradient overlay */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Спеціалісти з багаторічним досвідом лікування венозних патологій
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-3 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Сучасні малотравматичні процедури з швидким відновленням
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-3 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Лазерна та ультразвукова діагностика найвищого рівня
                </p>
              </div>
            </div>
          </div>
