...
export type GalleryAnalFissureSimptomImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const simptomImages: GalleryAnalFissureSimptomImage[] = [
  { src: "/images/procto/fissure/fissure15.jpg", alt: "Симптом анальної тріщини 1", width: 800, height: 600, title: "Дискомфорт та біль коло ануса" },
  { src: "/images/procto/fissure/fissure16.jpg", alt: "Симптом анальної тріщини 2", width: 800, height: 600, title: "Спазми сфінктера" },
    { src: "/images/procto/fissure/fissure7.jpg", alt: "Симптом анальної тріщини 2", width: 800, height: 600, title: "Поява кровотечі;" },
  { src: "/images/procto/fissure/proctology26.jpg", alt: "Симптом анальної тріщини 3", width: 800, height: 600, title: "В деяких випадках – свербіж та зуд." },
  { src: "/images/procto/fissure/fissure17.jpg", alt: "Симптом анальної тріщини 4", width: 800, height: 600, title: "Біль під час випорожнення кишківника" },
    { src: "/images/procto/fissure/fissure9.jpg", alt: "Симптом анальної тріщини 4", width: 800, height: 600, title: "гнійні виділення;" },
];

interface GalleryAnalFissureSimptomProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryAnalFissureSimptom({ className = "", style }: GalleryAnalFissureSimptomProps) {
