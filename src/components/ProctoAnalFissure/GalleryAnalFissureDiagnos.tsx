...
export type GalleryAnalFissureDiagnosImage = {
  src: string;
  alt: string;
  width: number;
  height: number;
...
const diagnosImages: GalleryAnalFissureDiagnosImage[] = [
  { src: "/images/procto/fissure/fissure19.jpg", alt: "Діагностика анальної тріщини 1", width: 800, height: 600, title: "пальцеве обстеження" },
  { src: "/images/procto/fissure/fissure22jpg.jpg", alt: "Діагностика анальної тріщини 2", width: 800, height: 600, title: "аноскопію" },
  { src: "/images/procto/fissure/fissure21.jpg", alt: "Діагностика анальної тріщини 3", width: 800, height: 600, title: "ректороманоскопію" },
  { src: "/images/procto/fissure/fissure24jpg.jpg", alt: "Діагностика анальної тріщини 4", width: 800, height: 600, title: "колоноскопію" },
  { src: "/images/procto/fissure/analFissure9.jpg", alt: "Діагностика анальної тріщини 4", width: 800, height: 600, title: "колоноскопію" },
  { src: "/images/procto/fissure/fissure24jpg.jpg", alt: "Діагностика анальної тріщини 4", width: 800, height: 600, title: "колоноскопію" },

];

interface GalleryAnalFissureDiagnosProps {
  className?: string;
  style?: React.CSSProperties;
}

export function GalleryAnalFissureDiagnos({ className = "", style }: GalleryAnalFissureDiagnosProps) {
